...
const TxSchema = new mongoose.Schema({
  ...
  type:        { type: String, enum: ['transfer','api','admin_add','admin_deduct','withdraw','gateway','redeem','keeper_deposit','keeper_withdraw','envelope','card_load','card_withdraw','card_pay','circle_pay'], default: 'transfer' },
